  ...
  return (
    <div className="body">
        ...
        <div className="frame">
            ...
            <div className="box">
                <div className="image">
                    <img src={Wukong} alt="Black Myth: Wukong" width="200" height="300" />
                </div>
                <div className="Title">
                    <h2>Black Myth: Wukong</h2>
                </div>
                <div className="Description">
                    <p>Black Myth: Wukong is an action RPG rooted in Chinese mythology. You shall set out as the Destined One to venture into the challenges and marvels ahead, to uncover the obscured truth beneath the veil of a glorious legend from the past.</p>
                </div>
                <div className="Price">
            ...
            <div className="box">
                <div className="image">
                    <img src={BaldursGate3} alt="Baldur's Gate 3" width="200" height="300" />
                </div>
                <div className="Title">
            ...
            <div className="box">
                ...
                <div className="Description">
                    <p>Descend into the depths of an alien underwater world filled with wonder and peril. Craft equipment, pilot submarines and out-smart wildlife to explore lush coral reefs, volcanoes, cave systems, and more - all while trying to survive.</p>
                </div>
                <div className="Price">
                    <h3>Price: RM72.00</h3>
                </div>
