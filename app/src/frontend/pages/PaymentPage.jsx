      ...
      <form action="post" className="flex flex-col items-center space-y-3 w-[80%] m-auto p-5">
        <div className="flex w-full items-center gap-4 rounded-md bg-gray-200 p-5">
          <input
            ...
            value="credit card"
          />
          <img className="h-8 w-16 bg-white object-scale-down" src="../../assets/payment-methods/credit_card.png" alt="" />
        ...
        <div className="flex w-full items-center gap-4 rounded-md bg-gray-200 p-5">
          <input
            ...
            value="touch n go"
          />
          <img className="h-8 w-16 bg-white object-scale-down" src="../../assets/payment-methods/Touch_'n_Go_logo.svg" alt="" />
          <label htmlFor="touch n go">Touch &#39;n Go</label>
        </div>
        <div className="flex w-full items-center gap-4 rounded-md bg-gray-200 p-5">
          <input className="h-5 w-5" type="radio" name="paymentMethod" />
          <img className="h-8 w-16 bg-white object-scale-down" src="../../assets/payment-methods/shopeepay4268.jpg" alt="" />
          <label htmlFor="">ShopeePay</label>
        </div>
        <div className="flex w-full items-center gap-4 rounded-md bg-gray-200 p-5">
          <input className="h-5 w-5" type="radio" name="paymentMethod" />
          <img className="h-8 w-16 bg-white object-scale-down" src="../../assets/payment-methods/GrabPay_Final_Logo_RGB_green_horizontal-01.png" alt="" />
